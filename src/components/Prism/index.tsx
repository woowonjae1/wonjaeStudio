...
const Prism = ({
  ...
  useEffect(() => {
    ...
    if (suspendWhenOffscreen) {
      ...
      startRAF();
      (
        container as HTMLDivElement & { __prismIO?: IntersectionObserver }
      ).__prismIO = io;
    } else {
      startRAF();
    }
    ...
    return () => {
      ...
      if (suspendWhenOffscreen) {
        const extContainer = container as HTMLDivElement & {
          __prismIO?: IntersectionObserver;
        };
        const io = extContainer.__prismIO;
        if (io) io.disconnect();
        delete extContainer.__prismIO;
      }
