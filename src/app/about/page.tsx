    ...
    <main className="flex min-h-screen flex-col items-center justify-center py-16 px-4">
      <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
        <div className="text-center py-8">
          <h1 className="text-4xl font-bold text-[#1C2C5B] mb-12">About Me</h1>
          ...
          <div className="px-8 max-w-2xl mx-auto">
            ...
            <p className="text-gray-700 mb-10">
              在这个博客中心，我希望与大家分享我的经验和技巧，帮助更多人踏上音乐创作的旅程。无论你是想学习基础知识，还是寻求高级技巧，我都很乐意提供帮助。
            </p>
            
            <div className="flex justify-center space-x-6 mt-8">
              <Link href="#" aria-label="Facebook">
                <svg className="w-6 h-6 text-[#1C2C5B] hover:text-[#98C5E9]" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
