          ...
          <header className="blog-section text-center">
            ...
            <div className="flex items-center justify-center mb-6">
              <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
                <div className="w-6 h-6 rounded-full bg-gray-900 dark:bg-white flex items-center justify-center text-white dark:text-gray-900 text-xs font-bold">
                  WJ
                </div>
            ...
            <h1 className="text-3xl md:text-4xl font-semibold mb-4 leading-tight text-gray-900 dark:text-white">
              {post.title}
            </h1>
